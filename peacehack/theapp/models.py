...
class CrazyObject(models.Model):
    ...
    ActionGeo_FeatureID = models.TextField(blank=True, null=True)
    ActionGeo_FullName = models.CharField(
        max_length=200, blank=True, null=True)
    ActionGeo_Lat = models.TextField(blank=True, null=True)
    ...
    Actor1Geo_CountryCode = models.TextField(blank=True, null=True)
    Actor1Geo_FeatureID = models.TextField(blank=True, null=True)
    ...
    Actor1Religion1Code = models.TextField(blank=True, null=True)
    Actor1Religion2Code = models.TextField(blank=True, null=True)
    Actor1Type1Code = models.TextField(blank=True, null=True)
    Actor1Type2Code = models.TextField(blank=True, null=True)
    Actor1Type3Code = models.TextField(blank=True, null=True)
    Actor2Code = models.TextField(blank=True, null=True)
    Actor2CountryCode = models.TextField(blank=True, null=True)
    Actor2EthnicCode = models.TextField(blank=True, null=True)
    Actor2Geo_ADM1Code = models.TextField(blank=True, null=True)
    Actor2Geo_CountryCode = models.CharField(
        max_length=15, blank=True, null=True)
    Actor2Geo_FeatureID = models.TextField(blank=True, null=True)
    ...
    Actor2Religion1Code = models.TextField(blank=True, null=True)
    Actor2Religion2Code = models.TextField(blank=True, null=True)
    Actor2Type1Code = models.TextField(blank=True, null=True)
    Actor2Type2Code = models.TextField(blank=True, null=True)
    Actor2Type3Code = models.TextField(blank=True, null=True)
