...
class CrazyObject(models.Model):
    ...
    ActionGeo_FeatureID = models.CharField(max_length=15, blank=True, null=True)
    ActionGeo_FullName = models.CharField(
        max_length=200, blank=True, null=True)
    ActionGeo_Lat = models.CharField(max_length=15, blank=True, null=True)
    ...
    Actor1Geo_CountryCode = models.CharField(max_length=15, blank=True, null=True)
    Actor1Geo_FeatureID = models.CharField(max_length=15, blank=True, null=True)
    ...
    Actor1Religion1Code = models.CharField(max_length=15, blank=True, null=True)
    Actor1Religion2Code = models.CharField(max_length=15, blank=True, null=True)
    Actor1Type1Code = models.CharField(max_length=15, blank=True, null=True)
    Actor1Type2Code = models.CharField(max_length=15, blank=True, null=True)
    Actor1Type3Code = models.CharField(max_length=15, blank=True, null=True)
    Actor2Code = models.CharField(max_length=15, blank=True, null=True)
    Actor2CountryCode = models.CharField(max_length=15, blank=True, null=True)
    Actor2EthnicCode = models.CharField(max_length=15, blank=True, null=True)
    Actor2Geo_ADM1Code = models.CharField(max_length=15, blank=True, null=True)
    Actor2Geo_CountryCode = models.CharField(
        max_length=15, blank=True, null=True)
    Actor2Geo_FeatureID = models.CharField(max_length=15, blank=True, null=True)
    ...
    Actor2Religion1Code = models.CharField(max_length=15, blank=True, null=True)
    Actor2Religion2Code = models.CharField(max_length=15, blank=True, null=True)
    Actor2Type1Code = models.CharField(max_length=15, blank=True, null=True)
    Actor2Type2Code = models.CharField(max_length=15, blank=True, null=True)
    Actor2Type3Code = models.CharField(max_length=15, blank=True, null=True)
    ...
    EventRootCode = models.IntegerField(db_index=True, blank=True, null=True)
    ...
    NumArticles = models.IntegerField(db_index=True, blank=True, null=True)
    NumMentions = models.IntegerField(db_index=True, blank=True, null=True)
